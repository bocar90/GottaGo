<?php
  ...
  session_start();
      ...
      if(isset($_POST['rideredittrip-submit'])){
        ...
        $query = "update passenger_trips set Depart_Street='$Depart_Street', Depart_City='$Depart_City', Depart_State='$Depart_State', Arrival_Street='$Arrival_Street', Arrival_City='$Arrival_City', Arrival_Stat='$Arrival_State', Date='$trip_date', Time='$trip_time' where id = ?";
